...
#define WAVE_HEIGHT 0.75 // Adjust wave height. [0.10 0.15 0.20 0.25 0.30 0.35 0.40 0.45 0.50 0.55 0.60 0.65 0.70 0.75 0.80 0.85 0.90 0.95 1.00 1.05 1.10 1.15 1.20 1.25]
...
vec3 GetWavesNormal(vec3 position, in float scale, in mat3 tbnMatrix) {
	...
	vec3 wavesNormal;
     ...
     wavesNormal.b = 2.1 - WATER_ROUGHNESS;
...
void main() {
  ...
  // gl_FragData[0] = vec4(tex.rgb, 0.2);
	gl_FragData[0] = vec4(vec3(0.0, 0.0, 0.0), WATER_DARKNESS);
