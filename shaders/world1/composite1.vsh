...
//colors for shadows/sunlight and sky
	...
	colorSunlight = mix(colorSunlight, colorSunlight * 5.5f, timeSunriseSunset);
	colorSunlight = mix(colorSunlight, colorSunlight * 0.7f, timeNoon);
	...
	//Torchlight color
	float torchWhiteBalance = 0.000f;
